...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:3000",   # original production/dev origin
        "http://127.0.0.1:3000",   # original production/dev origin
        "http://localhost:1420",   # ← added for Tauri/Vite dev server
    ],
